...
void read_csv(string &filename, string &seq_h, string &start_h, string &end_h, vector<string> &values,
              map<string, vector<Csv_line>> &content);
void ti_to_list(const vector<Csv_line> &df, string &date_column_name_start, string &date_column_name_end,
                vector<string> &val_column_names, int timemode, LinkedList &list_of_ti);
void utils_tiRead(string &filepath, char sep, string &seqid_column, string &date_column_name_start,
                  ...
                  vector<string> &ret_list_of_sequences, vector<LinkedList> &ret_list_of_ti_sequences,
                  int timemode = 1);
