...
public:
    ...
    VertTirpSidList join(VertTirpSidList &f, Allen &ps, eps_type eps, time_type min_gap = 0, time_type max_gap = MAXGAP, time_type max_duration = MAXDURATION, support_type min_ver_sup = 0, int min_confidence = 0.9);  //TODO min_confidence es int pero li dona valor 0.9
